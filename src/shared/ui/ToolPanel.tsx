...
const ALL_FIELDS: FieldTypeItem[] = [
  ...
  { key: 'countryCity', label: 'Страна и город', iconName: 'material-symbols:public', category: 'Контактная информация' },
  { key: 'location', label: 'Города и страны', iconName: 'material-symbols:travel-explore', category: 'Контактная информация' },
